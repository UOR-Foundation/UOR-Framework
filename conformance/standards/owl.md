...
All 881 named individuals must be typed with a known OWL class:
...
- 395 `op:Identity` individuals (algebraic identities across all algebra groups, including SC\_1–SC\_7, MS\_1–MS\_5, GD\_1–GD\_5, QM\_1–QM\_5, QT\_1–QT\_7, WC\_1–WC\_12, OA\_1–OA\_5)
...
- 289 proof individuals: `proof:prf_criticalIdentity` (CriticalIdentityProof), `proof:prf_criticalIdentity_axiomatic` (AxiomaticDerivation dual), `proof:prf_phi_1`–`proof:prf_phi_6` (ComputationCertificate), `proof:prf_AR_5` and `proof:prf_OA_4` (EmpiricalVerification), and 280 `proof:prf_*` AxiomaticDerivation individuals covering all remaining identities
