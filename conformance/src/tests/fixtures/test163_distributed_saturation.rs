/// SHACL fixture for distributed saturation (MC_6/MC_7) — Amendment 48.
pub const TEST163_DISTRIBUTED_SATURATION: &str = r#"
...
<urn:test:saturated_163> a owl:NamedIndividual , state:SaturatedContext ;
    state:isSaturated "true"^^xsd:boolean ;
    state:residualFreeCount "0"^^xsd:nonNegativeInteger .
"#;
