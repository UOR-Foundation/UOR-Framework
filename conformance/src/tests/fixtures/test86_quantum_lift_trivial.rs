/// SHACL test 86: QuantumLift with trivial LiftObstruction — Q1 lift (Amendment 39).
pub const TEST86_QUANTUM_LIFT_TRIVIAL: &str = r#"
...
type:ex_lift_86 a owl:NamedIndividual, type:QuantumLift ;
