/// SHACL test 82: QuantumLevel with levelSuccessor (Amendment 37, Gap 5).
...
schema:ex_ql_82 a owl:NamedIndividual, schema:QuantumLevel ;
    ...
    schema:levelSuccessor schema:Q0 .
"#;
