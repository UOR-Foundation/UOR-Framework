...
pub const TEST122_SESSION_SATURATION: &str = r#"
...
op:SR_6 a owl:NamedIndividual, op:Identity ;
    rdfs:label "SR_6" ;
    op:lhs "freeCount(q) after saturation" ;
    op:rhs "fibers of q not in BindingAccumulator" ;
...
op:SR_7 a owl:NamedIndividual, op:Identity ;
    ...
    op:rhs "min(sigma, 1 - freeCount(q)/n)" ;
