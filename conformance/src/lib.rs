...
/// 2. Ontology inventory (counts must equal 16/206/412/740)
/// 3. Ontology JSON-LD 1.1
/// 4. Ontology OWL 2 DL
/// 5. Ontology RDF 1.1 / Turtle 1.1
/// 6. SHACL instance conformance (100 test graphs)
...
mod tests_unit {
    ...
    fn spec_inventory_passes() {
        ...
        assert_eq!(ontology.class_count(), 206);
        assert_eq!(ontology.property_count(), 412);
        assert_eq!(ontology.individual_count(), 740);
    }
