...
fn classes() -> Vec<Class> {
    vec![
        ...
        Class {
            id: "https://uor.foundation/op/VerificationStatus",
            label: "VerificationStatus",
            comment: "A named verification status for an algebraic identity. \
                      Exactly two individuals exist: op:Verifiable (exhaustively \
                      checkable over R_n) and op:Derivable (follows from axioms \
...
fn properties() -> Vec<Property> {
    vec![
        ...
        Property {
            id: "https://uor.foundation/op/hasVerificationStatus",
            label: "hasVerificationStatus",
            comment: "The verification status of this identity: op:Verifiable \
                      (exhaustively checkable) or op:Derivable (follows from axioms). \
                      Functional: each identity has exactly one status.",
            kind: PropertyKind::Object,
            functional: true,
            domain: Some("https://uor.foundation/op/Identity"),
            range: "https://uor.foundation/op/VerificationStatus",
        },
        Property {
...
fn individuals() -> Vec<Individual> {
    vec![
        ...
        // Amendment 23: VerificationStatus individuals (2)
        Individual {
            id: "https://uor.foundation/op/Verifiable",
            type_: "https://uor.foundation/op/VerificationStatus",
            label: "Verifiable",
            comment: "The identity can be confirmed by exhaustive enumeration \
                      over R_n.",
            properties: &[],
        },
        Individual {
            id: "https://uor.foundation/op/Derivable",
            type_: "https://uor.foundation/op/VerificationStatus",
            label: "Derivable",
            comment: "The identity follows from previously established axioms \
                      or definitions by equational reasoning.",
            properties: &[],
        },
        ...
        Individual {
            ...
            properties: &[
                ...
                ("https://uor.foundation/op/hasVerificationStatus", IndividualValue::IriRef("https://uor.foundation/op/Verifiable")),
        ...
        Individual {
            ...
            properties: &[
                ...
                ("https://uor.foundation/op/hasVerificationStatus", IndividualValue::IriRef("https://uor.foundation/op/Derivable")),
