...
pub fn module() -> NamespaceModule {
    NamespaceModule {
        namespace: Namespace {
            ...
            space: Space::Bridge,
            imports: &[NS_OP, NS_CONVERGENCE, NS_STATE, NS_OBSERVABLE],
        },
        classes: classes(),
...
fn properties() -> Vec<Property> {
    vec![
        ...
        // AssociatorTriple properties
        Property {
            id: "https://uor.foundation/interaction/tripleEntityA",
            label: "tripleEntityA",
            comment: "First entity in the associator triple.",
            kind: PropertyKind::Datatype,
            functional: true,
        ...
        Property {
            id: "https://uor.foundation/interaction/tripleEntityB",
            label: "tripleEntityB",
            comment: "Second entity in the associator triple.",
            kind: PropertyKind::Datatype,
            functional: true,
            domain: Some("https://uor.foundation/interaction/AssociatorTriple"),
            range: XSD_STRING,
        ...
        Property {
            id: "https://uor.foundation/interaction/tripleEntityC",
            label: "tripleEntityC",
            comment: "Third entity in the associator triple.",
            kind: PropertyKind::Datatype,
            functional: true,
            domain: Some("https://uor.foundation/interaction/AssociatorTriple"),
            range: XSD_STRING,
        ...
        Property {
            id: "https://uor.foundation/interaction/associatorProfile",
            label: "associatorProfile",
            comment: "The associativity profile of the triple.",
            kind: PropertyKind::Datatype,
            functional: true,
            domain: Some("https://uor.foundation/interaction/AssociatorTriple"),
            range: XSD_STRING,
        ...
        Property {
            id: "https://uor.foundation/interaction/maxAssociatorNorm",
            label: "maxAssociatorNorm",
