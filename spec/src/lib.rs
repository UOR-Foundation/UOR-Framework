...
//! 16 namespaces, 206 classes, 412 properties, and 740 named individuals —
...
mod tests {
    ...
    fn class_count() {
        let total: usize = Ontology::full()
            ...
            .map(|m| m.classes.len())
            .sum();
        // 206 classes: 205 v4.2.0 + 1 Amdt38.
        assert_eq!(total, 206);
    }

    #[test]
    fn property_count() {
        // 412 = 408 v4.2.0 + 4 Amdt38.
        assert_eq!(Ontology::full().property_count(), 412);
    }
