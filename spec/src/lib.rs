...
//! 14 namespaces, 82 classes, 105 properties, and 13 named individuals —
...
mod tests {
    ...
    #[test]
    fn property_count() {
        // 119 = 118 namespace-level properties + 1 global uor:space annotation (Amendment 8).
        assert_eq!(Ontology::full().property_count(), 119);
    }
