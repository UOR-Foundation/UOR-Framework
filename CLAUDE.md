...
| `uor-conformance` | `conformance/` | no | 109-check conformance suite (OWL, SHACL, RDF, Rust API, docs, website) |
...
- **The conformance suite must pass.** `cargo run --bin uor-conformance` — 109 checks, zero failures allowed.
...
6. **SHACL** — 175 shapes (1:1 with classes), 45 instance test graphs
